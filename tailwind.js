...
module.exports = {
  ...
  |-----------------------------------------------------------------------------
  |
  | The color palette def
  ined above is also assigned to the "colors" key of
  ...
  */
  ...
  fonts: {
    ...
    'overpass': ['Overpass', '-apple-system', 'BlinkMacSystemFont', 'Helvetica Neue', 'Arial', 'sans-serif'], 
